...
const ProfileScreen = () => {
  ...
  const menuItems = [
    ...
    { title: 'Billing & Payments', icon: 'card' as const, onPress: () => router.push('/(renter)/billing') },
    { title: 'My Listings', icon: 'list' as const, onPress: () => router.push(accountType === 'owner' ? '/(owner)/owner-listings' : '/(renter)/my-listings') },
    { title: 'My Bookings', icon: 'calendar' as const, onPress: () => router.push('/(renter)/my-bookings') },
    { title: 'Favorites', icon: 'heart' as const, onPress: () => router.push('/(renter)/favorites') },
    { title: 'Reviews', icon: 'star' as const, onPress: () => router.push('/(renter)/reviews') },
    { title: 'Settings', icon: 'settings' as const, onPress: () => router.push('/(renter)/settings') },
    { title: 'Help & Support', icon: 'help-circle' as const, onPress: () => router.push('/(renter)/help') },
  ...
  return (
    <View style={styles.container}>
      ...
      <BackButton onPress={() => router.push('/(renter)')} />
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/(renter)/billing')}>
          ...
          <View style={styles.subscriptionCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push('/(renter)/billing')}
            >

...
const SettingsScreen = () => {
  ...
  const supportSettings = [
    {
      ...
      onPress: () => router.push('/(renter)/help'),
      showArrow: true,
    },
    {
      title: 'Contact Support',
      icon: 'chatbubble-outline',
      onPress: () => router.push('/(shared)/contact'),
      showArrow: true,
    },
    {
  ...
  const handleLogout = async () => {
    showConfirmationAlert(
      ...
      async () => {
        try {
          // Use the signOut function from Clerk
          await signOut();
    ...
    showConfirmationAlert(
      ...
      async () => {
        try {
          ...
          // Use Clerk's user deletion (this would need to be implemented in Clerk)
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: isDark ? DarkBackground : Background }}>
